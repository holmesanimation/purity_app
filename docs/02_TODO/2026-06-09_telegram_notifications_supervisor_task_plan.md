...
**File**: `d:\code\git_new\purity_app\services\settings_schemas.py`
...
**New file**: `d:\code\git_new\purity_app\services\telegram_notify.py`
...
**File**: `d:\code\git_new\purity_app\app.py`
...
**File**: `d:\code\git_new\purity_app\supervisor.py`
...
**New file**: `d:\code\git_new\purity_app\install_scheduled_task.py`
...
**New file**: `d:\code\git_new\purity_app\uninstall_scheduled_task.py`
- Calls `schtasks /Delete /F /TN PuritySupervisor`

## Phase 6: Update _launch_supervisor() to prefer task
**File**: `d:\code\git_new\purity_app\ui\main_window.py`
