...
_WEB_LAUNCHER     = _HERE.parent / "launchers" / "web_launcher.py"
_EXPLORE_LAUNCHER = _HERE.parent / "launchers" / "explorer_launcher.py"  # created later
...
$s.WorkingDirectory = '{_HERE.parent}'
